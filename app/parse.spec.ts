...
//     expect(splitSigniferFromRest('0:I{"a":"b"}', ":")).toStrictEqual([
//       "0",
//       'I{"a":"b"}',
//     ]);
//   });
...
//     expect(getLineType("{}")).toStrictEqual(undefined);
//   });
...
//     expect(getLineType("I{}")).toStrictEqual("I");
//   });
...
//     expect(getLineType("HZ[]")).toStrictEqual("HZ");
//   });

//   it("should find find a type in a complex case", () => {
//     expect(getLineType('HZ[[{"a":"b"}]]')).toStrictEqual("HZ");
//   });
// });
